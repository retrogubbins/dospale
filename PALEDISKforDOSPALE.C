...
// actually terrible code - the next test will be in error as ptr is already ince not tested
...
//                                      disk_track_buf[disk_track_buf_ptr]=Value;
        ...
        if((Port & 0xff)==0x58) //DISK Write Options
        {
                ...
                disk_options=Value;
                        ...
                        {
                                //FIXME - this assumes that the 'other bank' is always USER RAM
                                z80_map_read(0xe000, 0xFFFF, &bank1[0xe000]); // disk rom 
                        z80_map_fetch(0xe000, 0xFFFF, &bank1[0xe000]);
                        }       
